...
export const ROLE_COLORS: Record<UserRole, string> = {
  ...
  pic: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  keuangan: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",
  manajer: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300",
};
