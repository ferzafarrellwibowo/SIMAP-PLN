...
export function generateMockPaymentTrackings(contracts: Array<{
  ...
  return contracts.map((contract, index) => {
    ...
    return {
      ...
      judulPekerjaan: contract.judulPekerjaan || contract.judulPerjanjian || "-",
      vendor: contract.vendor || contract.namaVendor || "-",
      nilaiKontrak: contract.nilaiKontrak || contract.nilaiPerjanjian || 0,
      nilaiPerBulan,
      year,
      unit: contract.unit,
