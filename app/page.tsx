...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Dashboard Monitoring</h1>
        ...
        <div className="flex items-center gap-3">
          <Link href="/kontrak" className="px-4 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-2 shadow-sm">
            <DocumentIcon />
            Lihat Kontrak
          </Link>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {summaryCardConfig.map((config, index) => {
          ...
          return (
            ...
            >
              <div className={`rounded-xl border-l-4 ${config.borderColor} ${config.bgColor} p-5 shadow-sm border border-gray-200/50 dark:border-gray-700/50`}>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-300">{config.title}</p>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Ringkasan Kategori</h2>
          <Link href="/kontrak" className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 flex items-center gap-1">
            ...
            return (
              ...
              >
                <Link href={`/kontrak?kategori=${category.key}`} className="block">
                  <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 shadow-sm transition-all hover:shadow-md hover:border-gray-300 hover:bg-white dark:border-gray-700 dark:bg-gray-800/90 dark:hover:border-gray-600 dark:hover:bg-gray-800">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">{categoryContracts.length} kontrak • {aktifCount} aktif</p>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600 dark:text-gray-300">Total Nilai</span>
      ...
      <motion.div
        ...
        className="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800/90"
      >
        <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
              <ClockIcon />
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Kontrak Terbaru</h2>
            </div>
            <Link href="/kontrak" className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 flex items-center gap-1">
              Lihat Semua <ArrowRightIcon />
            </Link>
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {recentContracts.length === 0 ? (
            ...
            recentContracts.map((contract, index) => (
              ...
              >
                <Link href={`/kontrak/${contract.id}`} className="flex items-center justify-between px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                  ...
                  <div className="ml-4 flex-shrink-0 text-right">
                    ...
                    <div className="flex items-center justify-end gap-1 mt-1">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">{contract.persentaseRealisasi.toFixed(0)}%</span>
                    </div>
                  </div>
                </Link>
              </motion.div>
