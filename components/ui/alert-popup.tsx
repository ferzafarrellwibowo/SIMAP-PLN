    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-[100] min-w-[320px] max-w-md shadow-xl rounded-lg border p-4 ${type === "success"
                    ? "bg-green-50 border-green-200 dark:bg-green-900/95 dark:border-green-800"
                    : "bg-red-50 border-red-200 dark:bg-red-900/95 dark:border-red-800"
                    }`}
            >
                <div className="flex items-center gap-3">
                    ...
                    <p className={`font-medium text-sm ${type === "success"
                    ...
                    <button
                        onClick={onClose}
                        className={`ml-auto shrink-0 p-1 rounded-md hover:bg-opacity-20 ${type === "success"
